...
export default function TeamSection() {
  return (
    <section className="relative w-full bg-transparent pt-[114px] pb-[100px] px-4 bg-[#F4F3F8]">
          ...
          {items.map((item) => (
            ...
            >
              ...
              <div className="flex flex-col gap-2 text-center p-5">
                <h4 className="text-xl text-mons font-semibold">{item.name}</h4>
                <p className="mb-3 font-normal text-gray-700 ">{item.job}</p>
              </div>
            </div>
          ))}
        </div>
